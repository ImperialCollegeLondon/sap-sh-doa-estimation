% demo_piv loads a spherical microphone array recording and uses 
% pseudointensity vectors to estimate the directions of arrival
%
...
% - for PIV there is no point in going higher than 1 as they will not be
%   used
...
tic;
[est_doa_vec,counts,azg,incg,smoothed_histogram] = est_doas_piv(z,fs,mic,params);
elapsed = toc;
fprintf('PIV processing done in %2.1f seconds\n',elapsed);
...
set(gca,'clim',[-12 0])
title('Smoothed histogram of PIVs with estimated and true DOAs')
